...
public class SocketServer implements Runnable {
	...
	if (msg.content.equals(".bye")){
            ...
            if(msg.type.equals("login")){
                ...
                if(msg.recipient.equals("Group")){
                    clients[findClient(ID)].send(new Message("message", "SERVER", "Uploading to 'Group' forbidden", msg.sender));
                }
                else{
    ...
    public void Announce(String type, String sender, String content){
        Message msg = new Message(type, sender, content, "Group");
        for(int i = 0; i < clientCount; i++){
            clients[i].send(msg);
        }
    }
